...
const fakeBulletChartData = [
	{
		...
		current: 20.5, // Bank's current REL percentage
...
const thresholds = {
	good: 30, // Up to this is 'good' (e.g., green)
	warning: 40, // Above 'good' and up to this is 'warning' (e.g., orange)
...
export function DebtToIncomeRatioChart() {
	...
	return (
		<Card className="border shadow-none w-full gap-6">
			<CardHeader>
				<CardTitle>Debt-to-Income Ratio (DTI)</CardTitle>
				...
				<ChartContainer className="h-[60px] min-w-full" config={chartConfig}>
					...
					>
						...
						<ReferenceLine
							...
							label={{
								value: `(Current capacity: ${current}%)`,
